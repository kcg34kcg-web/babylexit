...
import { 
  Search, Users, TrendingUp, Hash, ArrowLeft, 
...
export default function LexwoowPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 pb-20 selection:bg-amber-100 font-sans">
      ...
      <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 p-4 shadow-sm">
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full bg-slate-100/50 border border-slate-200 rounded-full py-2.5 pl-10 pr-4 outline-none focus:ring-2 focus:ring-amber-500/10 focus:border-amber-500/50 text-sm transition-all placeholder:text-slate-400" 
            />
          </div>
        </div>
      </div>

      <main className="max-w-4xl mx-auto p-4 grid grid-cols-1 md:grid-cols-3 gap-8 mt-6">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 space-y-4">
                <textarea 
                  ...
                  className="w-full bg-transparent border-none outline-none resize-none text-slate-700 placeholder:text-slate-400 min-h-[120px] text-[16px] leading-relaxed pt-2" 
                />
                ...
                <div className="flex items-center justify-between border-t border-slate-100 pt-4">
                  ...
                  <button 
                    ...
                    className="bg-slate-900 hover:bg-black text-white px-10 py-2.5 rounded-2xl font-bold text-[13px] flex items-center gap-2 transition-all active:scale-95 disabled:opacity-20 shadow-xl shadow-slate-900/10"
                  >
